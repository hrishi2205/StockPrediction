...
def main():
    ...
    ticker = st.text_input("Enter Indian Stock Ticker (e.g. RELIANCE.NS, TCS.NS, INFY.NS)")
    ...
    if ticker:
        ...
        if not data.empty:
            ...
            with st.spinner("Training in progress..."):
                model.fit(X_train, y_train, batch_size=32, epochs=10, verbose=1, callbacks=[early_stopping])
